...
const Contact = () => <View style={styles.card}>
    ...
    <View style={styles.inner}>
        <ContactLine url="https://github.com/tsnobip" logo={githubLogo}>tsnobip</ContactLine>
        <Separator verticalMargin={8} />
        <ContactLine url="tel:+33675056161" logo={phoneLogo}>+33 6 75 05 61 61</ContactLine>
        <Separator verticalMargin={8} />
        <ContactLine url="mailto:paul.tsnobiladze@gmail.com" logo={emailLogo}>paul.tsnobiladze@gmail.com</ContactLine>
    </View>
</View>
