...
const Resume = () => <Document>
    <Page size="A4" style={page}>
        <View style={leftPan}>
            <Bio firstName="Paul" lastName="Tsnobiladzé" title="Computer engineer" profilePic={profilePic} >
                Product-centric developer.
                Functional Programming enthusiast.
                6 years of experience as a CTO and a software engineer in startups.
        </Bio>
            <Contact title="Contact" githubPseudo="tsnobip" phone="+33 6 75 05 61 61" email="paul.tsnobiladze@gmail.com" />
            <Contributions title="Main public contributions" contributions={[
            ...
            <DevSkills title="Tech stack" skills={[
            ...
            <Interests title="Interests" interests={[
        ...
        <View style={mainSection}>
            <Work title="Work experiences" durationTimeframe="duration in years / time frame"
                location="location" workExps={[

                    {
                        length: 0.7, timeframe: "Oct 2020 - Today", title: "Software engineer",
...
OCaml, Rescript, serverless services, Natural Language Processing...`
                    ...
                    {
                        length: 1.3, timeframe: "Jul 2019 - Oct 2020", title: "Founder",
                        company: "Dact", location: "Paris, FR",
...
in order to design an accessible workflow.`
                    ...
                    {
                        length: 0.7, timeframe: "Nov 2018 - Jun 2019", title: "CTO",
                        company: "En Marche", location: "Paris, FR",
...
topics on social media, ...`
                    ...
                    {
                        length: 3.1, timeframe: "Oct 2015 - Nov 2018", title: "CTO and Cofounder",
...
Filed two patents on RFID vending machines. Took part in two successful series of fundraising.`
                    ...
                    {
                        length: "2.0", timeframe: "Oct 2013 - Oct 2015", title: "Project manager",
...
Size of the projects: between 2 and 100 MEUR.`
                    ...
                    {
                        length: "0.5", timeframe: "Apr 2012 - Sept 2012", title: "Developer intern",
...
of Thales TopSky Air Traffic Control Systems. Development in Java, Swing and XML.`
            ...
            <Education title="Education" trainings={[
                ...
                },
                {
                    ...
                    details: "Semester in Artificial Intelligence and Data Visualization"
                }
