    ...
    <Page size="A4" style={page}>
      ...
      <View style={mainSection}>
        <Work
          ...
          durationTimeframe="nombre d'années / période"
...
afin de concevoir un processus de travail accessible.`,
            ...
            {
              length: 0.7,
              timeframe: "nov. 2018 - juin 2019",
              title: "CTO",
              company: "La République En Marche",
              location: "Paris, FR",
          ...
          trainings={[
            {
              ...
              timeframe: "2010 - 2013",
              details:
                "Option informatique, spécialité Dév Mobile, mineure en Design",
            },
            {
              ...
              details:
                "Semestre en intelligence artificielle et visualisation de l’information",
            },
          ]}
        />
      </View>
